...
是当前生产化 milestone 路线；M11-M16 在当前路线已按 2026-04-28
...
solver allocation work 仍是 Post-M16 follow-up。M16 Dense Island Execution 已
把 contact/joint active-island batching 收敛为 deterministic island-local
body slots / contact row indices / joint rows，后续性能深化仍以 benchmark/counter
evidence 为准。
